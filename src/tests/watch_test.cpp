...
namespace rev {
	namespace test {
		class FileWatchTest: public Random {};
		namespace {
			class FEvSet : public std::unordered_map<const FEv*, FEv_UP, FEv_hash, FEv_equal> {
				public:
					void addEvent(FEv* e) {
						emplace(e, FEv_UP(e));
					}
			...
			class INodeNtf : public FRecvNotify {
				...
				public:
					...
					void event(const FEv_Create& e, const Data_SP& /*ud*/) override { _event(e); }
					void event(const FEv_Access& e, const Data_SP& /*ud*/) override { _event(e); }
					void event(const FEv_Modify& e, const Data_SP& /*ud*/) override { _event(e); }
					void event(const FEv_Remove& e, const Data_SP& /*ud*/) override { _event(e); }
					void event(const FEv_MoveFrom& e, const Data_SP& /*ud*/) override { _event(e); }
					void event(const FEv_MoveTo& e, const Data_SP& /*ud*/) override { _event(e); }
					void event(const FEv_Attr& e, const Data_SP& /*ud*/) override { _event(e); }
			...
			class Ntf : public ActionNotify {
				private:
					FEvSet			_set;
					const String_SP	_basePath;
					const int		_nseg;
				public:
					Ntf(const String_SP& basePath, const int nseg):
						_basePath(basePath),
						_nseg(nseg)
					{}
